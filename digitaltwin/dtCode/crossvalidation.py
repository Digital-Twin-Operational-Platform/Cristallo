...
from digitaltwin.dtLib.crossval.extract_data import tSW,tSO,tSH,tBR,youtSW,youtSO,youtSH,youtBR
from digitaltwin.dtLib.crossval.extract_data import tNumSW,tNumSWmiddle,tNumSO,tNumSH,tNumBR,tNumSHmiddle,youtNumSW,youtNumSO,youtNumSH,youtNumBR
