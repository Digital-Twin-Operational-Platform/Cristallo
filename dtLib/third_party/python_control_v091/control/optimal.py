...
from . import (isctime, input_output_response, NonlinearIOSystem, config)
import warnings
import logging
import time
...
class OptimalControlProblem():
    ...
    def _cost_function(self, coeffs):
        ...
        if np.array_equal(coeffs, self.last_coeffs) and \
           np.array_equal(x, self.last_x):
            ...
            _, _, states = input_output_response(
    ...
    def compute_trajectory(
        ...
        return_states = config._get_param(
