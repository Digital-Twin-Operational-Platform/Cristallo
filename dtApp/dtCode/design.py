...
@app.route('/Design_under_uncertainty_output', methods=['GET', 'POST'])
def OutDis():
    global flag_2
...
@app.route('/Design_under_uncertainty_fisher', methods=['GET', 'POST'])
def start_method():
...
@app.route('/Design_under_uncertainty_sensitivity', methods=['GET', 'POST'])
def testt():
    Ntop = (JPDFsize-1)
    Stp = 100/Ntop
